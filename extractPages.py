...
class TextConverter(PDFConverter):
    def __init__(self, rsrcmgr, outfp, codec='utf-8', pageno=1, laparams=None,
                 showpageno=False, imagewriter=None,to_remove=[]):
...
def extract_text(pdf_file, password='', page_numbers=None, maxpages=0,
                 caching=True, codec='utf-8', laparams=None,to_remove=[],showpageno=False):
    ...
    with pdf_file as fp, StringIO() as output_string:
        ...
        device = TextConverter(rsrcmgr, output_string, codec=codec,
                               laparams=laparams,to_remove=to_remove,showpageno=showpageno)
...
def extract_wrapper_outline(fp):
    ...
    return extract_text(fp,laparams=LAParams(line_margin=2,char_margin=3,boxes_flow=-1),to_remove=to_remove,showpageno=True)
...
def extract_wrapper(fp,page_numbers=None):
    ...
    return extract_text(fp,laparams=LAParams(line_margin=2,char_margin=3,boxes_flow=-1),to_remove=to_remove,page_numbers=page_numbers)
